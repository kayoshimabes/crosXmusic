...
from crosmusic.modules.play import arq
...
def song(client, message):
    ...
    try:
        ...
        m.edit("❌ тι∂αк мєηємυкαη αρα-αρα.\n\n¢σвα ℓαgυ ℓαιη αтαυ мυηgкιη мєηgєʝαηуα ∂єηgαη вєηαя.")
        print(str(e))
        return
    m.edit("📥 **Downloading**")
    try:
        ...
        rep = "**🤖 υρℓσα∂єя вує :** [{BOT_NAME}](https://t.me/{BOT_USERNAME})"
